define(["dojo/_base/declare", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dojo/text!./templates/multipleUploader.html", "dojo/on", "dojo/dom-attr", "dojo/dom-class"], function (declare, _WidgetBase, _TemplatedMixin, template, on, domAttr, domClass) {
    ...
    return declare([_WidgetBase, _TemplatedMixin], {
        ...
        reset: function () {
            ...
            _this.value = "";
            _this.displayTextNode.value = _this.value;
            domAttr.set(_this.displayTextNode, 'title', "");
            _this.hiddenFileNode.value = "";
        }
    });//return
});//define