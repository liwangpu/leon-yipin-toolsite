...
namespace ToolSiteAPI.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [HttpPost("ExtractSingleArea")]
        public async Task<IActionResult> ExtractSingleArea()
        {
            ...
            return Ok(orderFileName);
        }


        [HttpPost("ExtractMixtureArea")]
        public async Task<IActionResult> ExtractMixtureArea()
        {
            var tmpFolder = Path.Combine(env.WebRootPath, "tmp");
            var orderFileName = Guid.NewGuid().ToString() + ".xlsx";
            var orderFilePath = Path.Combine(tmpFolder, orderFileName);
