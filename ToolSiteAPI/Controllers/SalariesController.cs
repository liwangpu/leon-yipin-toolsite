...
namespace ToolSiteAPI.Controllers
{
    ...
    public class SalariesController : ControllerBase
    {
        ...
        [HttpPost("WarehouseOvertime")]
        public async Task<IActionResult> WarehouseOvertime()
        {
        ...
        /// </summary>
        /// <returns></returns>
        [HttpPost("DailyWorkingHours")]
        public async Task<IActionResult> DailyWorkingHours()
        {
            var tmpFolder = Path.Combine(env.WebRootPath, "tmp");
            var workingHoursCacheFolder = Path.Combine(env.WebRootPath, "cache", PickingPerfMonthlyWorkingHoursCacheFolder);
        ...
        /// </summary>
        /// <returns></returns>
        [HttpPost("DownloadSpecifyDatePerf")]
        ...
        /// </summary>
        /// <returns></returns>
        [HttpPost("WatchWholeMonthPerfMessage")]
